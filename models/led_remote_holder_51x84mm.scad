...
//
// OpenGrid wall holder for a 51 x 84 x 7 mm LED-strip controller remote.
//
...
//
// Twin model: led_remote_holder_55x124mm.scad is this same design with
...
// ----- Remote -----
remote_w = 51;    // @param number min=40 max=70 step=0.5 unit=mm group=remote label="Remote width"
remote_h = 84;    // @param number min=70 max=120 step=0.5 unit=mm group=remote label="Remote height"
remote_d = 7;     // @param number min=4 max=12 step=0.1 unit=mm group=remote label="Remote depth"
...
// margins stay small enough to print support-free. 90 = no-op at
// this model's defaults (full length is 87.3).
