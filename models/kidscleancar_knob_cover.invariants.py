...
against the exported STL (deck surface at z = 0):
...
def _solid(stl, pts):
    """Majority-robust containment for a list of (x,y,z) points."""
...
def check(ctx):
    ...
    if _solid(stl, [(annulus_r, 0.0, screw_top - 0.5)])[0]:
        failures.append(Failure(
            "screw-clearance",
