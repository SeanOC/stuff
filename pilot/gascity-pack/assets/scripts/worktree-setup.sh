...
# Prune stale worktree registrations (e.g. left by a torn-down city) so
# `git worktree add` doesn't fail on a registered-but-missing path. Observed
# live in the st-qr2 pilot; co-8h7b precondition.
